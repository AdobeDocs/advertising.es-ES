...
>[!NOTE]
>
>También puede [compartir y dejar de compartir un ID de acuerdo con todos los anunciantes de cuentas especificadas](deal-id-share.md).

1. En el menú principal, haga clic en **[!UICONTROL Inventory]** > **[!UICONTROL Deals].**

1. En la fila de la oferta, haga clic en  **[!UICONTROL ...]** > **[!UICONTROL Manage Advertisers]**.
...
1. Clic **[!UICONTROL Save]** para guardar la configuración de la oferta.

>[!MORELIKETHIS]
>* [Acerca del inventario privado](private-inventory-about.md)
>* [Edición de las cuentas con acceso a un ID de acuerdo](/help/dsp/inventory/deal-id-share.md)
