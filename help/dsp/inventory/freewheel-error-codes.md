...
| [!DNL Invalid external_deal_id:] \&lt;deal_id\> | El ID de oferta enviado no existe o no está activo en el extremo de Adobe. | Asegúrese de que la oferta esté activa y vuelva a enviar el anuncio. |
...
| [!DNL Ad with identifier] \&lt;*nombre del anuncio*\> [!DNL was not found.] | La clave de anuncio enviada no existe o no está activa en el extremo de Adobe. | Busque la clave de anuncio correcta y, a continuación, vuelva a enviar el anuncio. |
...
| DATA_DSP_GET_FAILURE | 422 | La DSP no existe dentro del sistema. |
