...
* Configure los ID de acuerdo privados directamente con [!DNL Roku] y luego ingrese los datos del ID de acuerdo en DSP.

* Visite la galería [!DNL On Demand] para suscribirse a [!DNL Roku] perfiles:
...
Cada ubicación de [!DNL Roku] debe estar dirigida al menos a un origen o acuerdo de [!DNL Roku]. Para usar la coincidencia de audiencia de DSP con [!DNL Roku], incluya uno o más segmentos de audiencia que puedan coincidir con el conjunto de datos determinista [!DNL Roku] (incluido).
