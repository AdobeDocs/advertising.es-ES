---
title: Aceptar una oferta en [!UICONTROL Deal ID Inbox]
...
# Aceptar una oferta en [!UICONTROL Deal ID Inbox]

*Usuarios en cuentas de DSP asignadas únicamente a cuentas de SSP*
...
>[!NOTE]
>
>La configuración de acuerdos programáticos garantizados con editores en [!DNL FreeWheel] requiere permisos y pasos adicionales. Consulte &quot;[Información general sobre la configuración de ofertas programáticas garantizadas en FreeWheel](freewheel-overview.md)&quot; para obtener más información.
...
1. (Opcional) Para actualizar los detalles de la oferta, haga clic en **[!UICONTROL Refresh]**.
   ...
   DSP actualiza automáticamente todos los detalles de la oferta todos los días a las 4:30 a.m. EST. También actualiza todas las [!DNL FreeWheel] ofertas y actualiza las ofertas existentes de [!DNL Google] y [!DNL Magnite DV+] por hora.
...
>[!MORELIKETHIS]
>
>* [Acerca de [!UICONTROL Deal ID Inbox]](deal-id-inbox-about.md)
...
>* [Descripción general de las características del inventario](inventory-overview.md)
