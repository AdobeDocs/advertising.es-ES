...
>[!NOTE]
>
>Si lo desea, puede recuperar informes de exclusión de venta de consumidores mediante DSP [!DNL Trafficking API]. Para obtener instrucciones, consulte la documentación de [!DNL Trafficking API]. Si su organización no utiliza [!DNL Trafficking API] pero está interesada en obtener más información, póngase en contacto con el equipo de cuenta de Adobe.
