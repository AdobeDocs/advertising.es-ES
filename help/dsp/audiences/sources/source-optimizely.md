...
1. Siga las [[!DNL Optimizely's] instrucciones de para insertar el segmento en DSP](https://support.optimizely.com/hc/en-us/articles/27974930963981-Integrate-Adobe-Ads). Incluya la siguiente información para habilitar la integración:

   * **Clave de Source:** Esta es la clave de origen creada en [Paso 2](#source-create).

   * **Código de cuenta:** Este es el código alfanumérico de cuenta de DSP que puede encontrar en DSP en [!UICONTROL Settings] > [!UICONTROL Account].
