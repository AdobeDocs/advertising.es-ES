...
Cuando edita una audiencia que se utiliza en ubicaciones u otras audiencias reutilizables, los cambios se aplican inmediatamente a esas ubicaciones y audiencias.<!-- verify -->
...
1. Edite la configuración de audiencia de cualquiera de estas formas:
   ...
   >[!NOTE]
   >
   >Si edita la lógica de segmentos de audiencia, se detalla lo siguiente [datos de tamaño de audiencia](audience-about.md) se actualiza en el panel derecho.

   * (Opcional) Para editar la variable **[!UICONTROL Audience Name]** click ![Editar](/help/dsp/assets/edit.png) junto al nombre de la audiencia, escriba un nombre de audiencia único y haga clic en **[!UICONTROL Apply]**.

   * (Opcional) Para editar manualmente la lógica del segmento, utilice los segmentos disponibles en la [[!UICONTROL Third Party Segments], [!UICONTROL First Party Segments], [!UICONTROL Adobe Segments], [!UICONTROL Custom Segments], y [!UICONTROL Saved Audiences] pestañas](audience-settings.md), haga lo siguiente.
