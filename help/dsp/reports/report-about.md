...
* Plantillas de informe preconfiguradas
   ...
   * **[!UICONTROL Household]:** Utilice este informe para ver impresiones, alcance y frecuencia de una sola dimensión en diferentes formatos de anuncio a nivel de hogar en función de la dirección IP, en lugar de a nivel de dispositivo/cookie. Use perspectivas para optimizar su combinación de medios, mejorar el rendimiento e identificar oportunidades para un alcance incremental. Consulte &quot;[Preguntas frecuentes sobre los informes de hogares](/help/dsp/reports/faq-household-report.md)&quot; para obtener más información.
