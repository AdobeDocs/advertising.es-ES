...
>[!NOTE]
>
>Las rutas de conversión incluyen todas las impresiones y clics dentro de las ventanas de retrospectiva de clics o impresiones del anunciante, que están configuradas en [!DNL Advertising Search, Social, & Commerce]. Los clics tienen preferencia sobre las impresiones durante la atribución de conversión. Cualquier clic en una ruta de conversión recibe crédito completo en función de la regla de atribución. Las impresiones reciben crédito solo cuando no se realiza un seguimiento de ningún clic en la ruta de conversión.
...
* *[!UICONTROL Display Only]:*  Atributos conversiones al último clic o impresión DSP en la ruta de conversión. Esto incluye vídeo y anuncios de TV conectados, y excluye los clics en [!DNL Advertising Search, Social, & Commerce] anuncios.
