...
[!UICONTROL Troubleshooting Agent] con asistencia de IA puede:

* Ayuda para diagnosticar problemas de rendimiento y envío de un paquete o una ubicación en directo seleccionados. Puede preguntar por problemas de gasto (error de gasto, bajo gasto, exceso de gasto), problemas de ritmo (ritmo insuficiente, ritmo excesivo), problemas de subasta y entrega (ofertas bajas, tasa de ganancia baja, sin impresiones) y problemas de rendimiento (como cambios en CPA, ROAS, CTR o CVR).
...
### Solución de problemas de rendimiento y entrega
...
1. (Opcional; solo preguntas generales sobre el producto) Para abrir una página utilizada como fuente de datos, siga uno de estos procedimientos:
