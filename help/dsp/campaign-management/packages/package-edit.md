...
>[!NOTE]
>
>También puede descargar la configuración de uno o más paquetes en formato XLSX (hoja de cálculo de Excel), realizar cambios en la mayoría de los campos y cargarlos de nuevo en DSP de una vez. Consulte &quot;[Revisar y editar la configuración del paquete mediante hojas de edición masiva](package-qa.md).&quot;
