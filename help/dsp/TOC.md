...
+ Campaign Management {#campaign-management}
   ...
   + Ubicaciones {#placements}
      ...
      + [Adjuntar un anuncio a una ubicación](/help/dsp/campaign-management/ads/ad-attach-to-placement.md)
   ...
   + Informes de campaña {#campaign-reports}
      ...
      + Administrar vistas de datos {#data-views}
         ...
         + [Cambio de la vista de columna](/help/dsp/campaign-management/reports/column-view-change.md)
         ...
         + [Filtrado de datos de Campaign](/help/dsp/campaign-management/reports/campaign-data-filter.md)
...
+ Optimización {#optimization}
   ...
   + Objetivos personalizados {#custom-goals}
      ...
      + [Crear una meta personalizada](/help/dsp/optimization/custom-goal-create.md)
...
+ [Atención al cliente](https://helpx.adobe.com/es/contact/enterprise-support.ec.html)
