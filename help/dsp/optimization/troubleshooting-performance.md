---
title: Motivos de los problemas de rendimiento
...
ht-degree: 0%
---
# Motivos de los problemas de rendimiento
...
| --- | --- | --- |
| Sin gasto en ubicación | La ubicación no incluye anuncios o los anuncios no están activos. | Verifique que todos los anuncios esperados estén adjuntos a la ubicación y que estén aprobados y activos.<br><br>Además, vea si la ubicación incluye un horario de anuncios personalizado, lo que puede limitar el período de vuelo de cada anuncio. Para ver la programación de anuncios de una ubicación desde la vista Ubicaciones, haga clic en **[!UICONTROL ...]** > **[!UICONTROL Ad schedule]** junto al nombre de la ubicación. |
| | Las fechas afectadas no se encuentran dentro de las fechas de vuelo configuradas. | Compruebe que las fechas de vuelo son válidas en los niveles de campaña, paquete y ubicación. |
...
| | La ubicación tiene una tasa de ganancia baja. | Aumente [!UICONTROL Max Bid] para mejorar la tasa de ganancia.<br><br><b>NOTA:</b> Los precios de inventario pueden variar según el objetivo de la ubicación.<br><br>Una tasa de ganancia del 10% se considera saludable. |
