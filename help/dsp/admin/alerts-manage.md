...
1. En la sección **[!UICONTROL Add Alerts]**:
   ...
   1. (Opcional) Para ejecutar la alerta de inmediato, seleccione **[!UICONTROL Alert immediately]**. De manera predeterminada, la alerta se ejecuta a las 08:00 en el huso horario de la cuenta.
...
## Administración de alertas de una suscripción
...
## Administración de los suscriptores de una suscripción
...
## Desactivación o activación de una suscripción
