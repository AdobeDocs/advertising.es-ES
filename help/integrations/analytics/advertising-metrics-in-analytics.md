...
Ver las [clasificaciones para la dimensión de ID de AMO](https://experienceleague.adobe.com/es/docs/analytics/components/dimensions/amo-id#classifications).
<!--
