...
Adobe recomienda trabajar con su equipo [!DNL Analytics] para generar un conjunto completo de [!DNL Marketing Channels] reglas de procesamiento que hagan un seguimiento de todos los canales relevantes. Al hacerlo, puede crear potentes informes de atribución.
