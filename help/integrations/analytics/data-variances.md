...
Si ha iniciado sesión en [!DNL Search], puede encontrar una lista
...
Adobe Advertising proporciona a Analytics [métricas de tráfico específicas de la publicidad y las dimensiones relacionadas de [!DNL DSP] y [!DNL Search]](advertising-metrics-in-analytics.md). Las métricas proporcionadas por la publicidad de Adobe solo son aplicables a las dimensiones especificadas de la publicidad de Adobe y los datos no están disponibles para otras dimensiones en [!DNL Analytics].
