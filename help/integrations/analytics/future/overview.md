...
* **[!DNL Analytics]segmentos:** Metadatos, datos de jerarquía y datos de audiencia única para todos los segmentos de un anunciante o agencia creados en [!DNL Analytics] y publicados en Adobe CX Enterprise.
