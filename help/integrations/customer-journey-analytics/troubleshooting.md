...
| Falta el código incrustado o el entorno es incorrecto | Compruebe que el [[!DNL Tags] código incrustado](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/environments/environments) en la página web hace referencia al entorno correcto (Dev/Stage/Prod). Busque el entorno en la etiqueta `<head>` para la etiqueta de script `//assets.adobedtm.com/...`. |
| Conflicto de carga asíncrona frente a sincrónica | Asegúrese de que solo hay un [[!DNL Tags] código incrustado](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/environments/environments) por página web. Los códigos incrustados duplicados causan condiciones de carrera. |
| Bloqueo de la política de seguridad de contenido (CSP) | Agregue `edge.adobedc.net` `and assets.adobedtm.com` a sus [directivas CSP `connect-src` y `script-src`](https://experienceleague.adobe.com/en/docs/experience-platform/collection/use-cases/configuring-a-csp). |
...
* La regla se guardará y se incluirá en la [compilación de biblioteca](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/builds) activa.
...
* Las condiciones de la regla no son demasiado restrictivas. Realice pruebas [eliminando condiciones](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules) temporalmente para aislar el problema.
* El orden de las reglas es correcto. Si varias reglas comparten el mismo evento, compruebe la [ordenación de reglas](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules).
