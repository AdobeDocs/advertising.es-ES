...
| Faltan los campos de Adobe Advertising requeridos en el esquema | Asegúrese de que los campos de Adobe Advertising necesarios estén presentes en el esquema en `_experience.adcloud.conversionDetails` (consulte la tabla de referencia de campos que aparece a continuación).<br><br>Si falta alguno de los campos, confirme que el grupo de campos **Adobe Advertising Cloud ExperienceEvent Full Extension** se guardó en el esquema y, a continuación, actualice el editor de esquemas. |
| La dirección URL de la página de aterrizaje no incluye los parámetros de consulta necesarios | Asegúrese de que la dirección URL de la página de aterrizaje incluye los parámetros de consulta necesarios. En una pulsación de anuncio, la dirección URL de la página de aterrizaje debe contener ambos parámetros de consulta, por ejemplo `https://www.example.com/landing-page?s_kwcid=AL!12345!3!abc123&ef_id=abc123xyz:G:s` (consulte la tabla de referencia siguiente para ver las causas probables). |
...
**Referencia: campos de esquema requeridos**
...
**Referencia: faltan parámetros de consulta**
