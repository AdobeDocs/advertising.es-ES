...
+ [!DNL Analytics for Advertising] {#analytics}
   ...
   + Trabajando en [!DNL Analytics Marketing Channels] {#mc}
      ...
      + [Uso de [!DNL Marketing Channels] con datos publicitarios de Adobe](/help/integrations/analytics/marketing-channels/mc-ac-data.md)
...
+ Integración con Adobe Audience Manager {#audience-manager}
   ...
   + [Importar segmentos de Audience Manager a publicidad de Adobe](/help/integrations/audience-manager/import-audiences.md)
...
+ [Vídeos Tutorials Acerca de las integraciones de publicidad de Adobe](https://experienceleague.adobe.com/docs/advertising-learn/tutorials/overview.html)<!-- rename if the tutorials TOC structure changes -->
