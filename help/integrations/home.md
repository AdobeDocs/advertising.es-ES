...
| ---- | ------- | ----------- | -------------------- |
| Publicado el 29 de octubre de 2024 | [!DNL Adobe Analytics for Advertising] | (Anunciantes con [!DNL Adobe Analytics for Advertising] y [!DNL Microsoft Advertising] campañas de rendimiento máximo) Los datos de nivel de grupo de recursos para sus campañas de rendimiento máximo ahora están disponibles en Adobe Analytics al implementar un nuevo parámetro de ID de AMO ([!DNL s_kwcid]) en las direcciones URL de seguimiento para sus campañas de rendimiento máximo, que no incluyen anuncios y palabras clave. El seguimiento de la mayoría de las campañas Máximo rendimiento ya se ha migrado al nuevo formato. Para las campañas de rendimiento máximo sin la opción de seguimiento [!UICONTROL Auto Upload] que aún no se migraron al nuevo formato, sin embargo, debe actualizar manualmente cada sufijo de página de aterrizaje para incluir el siguiente formato de ID de AMO:<br><br>`AL!%(userid)d!%(sid)d!%(creativeref)s!!!%(termid/orderid)d!!!%(campaignid)!%(adref)`<br><br>Los datos de Adobe Analytics para sus campañas de rendimiento máximo también están disponibles en Search, Social y Commerce. | Consulte el nuevo [formato de ID de AMO]((/help/integrations/analytics/ids.md #amo-id-format-search) y [cuándo y cómo añadir el parámetro a las URL de seguimiento](/help/integrations/analytics/ids.md#amo-id-implement). |
