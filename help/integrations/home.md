...
| ---- | ------- | ----------- | -------------------- |
| 16 de diciembre de 2023 | Ayuda | Un nuevo documento explica cómo configurar pruebas A/B en [!DNL Target] para el tráfico de clics de anuncios en Search, Social y Commerce, así como sugerencias sobre cómo medir y visualizar las pruebas en [!DNL Analytics]. | Consulte &quot;[Configuración de pruebas A/B en Adobe Target para anuncios de Search, Social y Commerce](/help/integrations/target/ab-tests-search.md).&quot; |
| 8 de agosto de 2023 | [!DNL Analytics for Advertising] | Algunos [!DNL Analytics] DSP Las métricas de evento de éxito, incluidas las métricas de conversión estándar, personalizadas y reservadas, y las métricas de tráfico, están disponibles automáticamente en y en Búsqueda, Social y Commerce. Ahora, también puede configurar sus propias métricas de éxito en función de sus [!DNL Analytics] [!DNL eVars] y [!DNL props] por canalización [!DNL eVar]- y [!DNL prop]datos de nivel de en un evento de éxito personalizado. | Consulte &quot;[Crear métricas de conversión desde Adobe Analytics [!DNL eVars] y [!DNL Props]](/help/integrations/analytics/conversion-metrics-from-evars.md).&quot; |
...
| 27 de octubre de 2021 | [!DNL Analytics for Advertising] | Si su organización desea dejar de utilizar el Adobe Analytics heredado `visitorAPI.js` a la biblioteca de [Adobe Experience Platform [!DNL Web SDK]](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html) biblioteca (`alloy.js`) para la recopilación de datos, debe realizar algunos cambios para habilitar la vinculación de ID. | Consulte &quot;[Uso del [!DNL Last Event Service] Biblioteca JavaScript con Adobe Experience Platform [!DNL Web SDK]](/help/integrations/analytics/web-sdk.md).&quot; |
