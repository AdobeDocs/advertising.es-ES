...
description: Obtenga información sobre cómo configurar una prueba A/B en [!DNL Target] DSP para su y [!DNL Search] anuncios.
...
# Configuración de pruebas A/B en Adobe Target DSP para Advertising y [!DNL Advertising Search] Anuncios
