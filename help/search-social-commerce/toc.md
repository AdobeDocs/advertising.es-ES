...
+ (Beta) NUEVA INTERFAZ DE USUARIO {#new-ui}
   ...
   + Informes {#reports}
      + Informes programados {#scheduled}
         + [Acerca de los informes](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/report-about)
         + [Las tareas de configuración iniciales para los informes](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/initial-setup)
         + [Los datos utilizados para los informes](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/data-used-for-reports)
      + Administración de informes {#report-management}
         ...
         + [Cálculo de las reglas de atribución](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/attribution-rules)
         + [Preguntas frecuentes sobre informes personalizados](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/insights-reports/reports/faqs-report)
