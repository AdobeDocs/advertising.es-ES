...
| ---- | ------- | ----------- | -------------------- |
| 30 de junio de 2023 | [!UICONTROL Asset Library] | (Función beta) En [!UICONTROL Campaigns] > [!UICONTROL Asset Library (Beta)], puede crear recursos de imagen, vídeo y texto reutilizables y cargarlos en su [!DNL Google] biblioteca de recursos de nivel de cuenta. Puede utilizar sus recursos para las publicidades cuando cree o edite campañas dentro de [!DNL Google Ads] editor. | Consulte &quot;[Creación y carga de recursos](/help/search-social-commerce/campaign-management/asset-library/asset-create.md).&quot; |
