---
title: 'Cambiar el estado de una regla de valor de conversión  [!DNL Google Ads] '
description: Aprenda a cambiar el estado de  [!DNL Google Ads] las reglas de valor de conversión.
...
# Cambiar el estado de una regla de valor de conversión [!DNL Google Ads]
