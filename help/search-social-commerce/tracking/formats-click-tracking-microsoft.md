...
>
>* `{TargetId}` representa el identificador de a) la palabra clave o b) la palabra clave y la lista de remarketing (audiencia) que activaron el anuncio (por ejemplo, &quot;kwd-123:aud-456&quot; tanto para una palabra clave como para una lista de remarketing o &quot;kwd-123&quot; solo para palabra clave).
