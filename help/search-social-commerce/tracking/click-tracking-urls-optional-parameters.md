...
| <code>{ef_adid}</code> | Para insertar el ID de anuncio. <b>Nota:</b> El identificador de un anuncio nuevo no se creará hasta que se publique el anuncio en la red publicitaria. Si la cuenta usa las opciones &quot;[!UICONTROL EF Redirect]&quot; y [!UICONTROL Auto Upload]&quot;, Adobe Advertising inserta automáticamente el ID de anuncio en las direcciones URL de destino o finales relevantes al día siguiente. Si la cuenta no utiliza las opciones &quot;[!UICONTROL EF Redirect]&quot; y [!UICONTROL Auto Upload]&quot; y desea insertar el ID de anuncio en las direcciones URL de destino o URL finales relevantes, debe crear el anuncio, descargar un archivo de hoja de edición por lotes para el nuevo anuncio y utilizar la opción para &quot;Generar direcciones URL de seguimiento&quot; y, a continuación, publicar el archivo en la red de anuncios. |
...
## [!DNL LY Ads] parámetros de seguimiento dinámico
