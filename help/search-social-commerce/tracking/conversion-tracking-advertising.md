...
Adobe Advertising realiza un seguimiento de las conversiones resultantes de los clics en las publicidades mediante las etiquetas de seguimiento de conversión de Adobe Advertising que se insertan en las páginas web que se abren cuando se produce un evento de conversión, como una página de &quot;éxito&quot;. Las etiquetas incluyen información incrustada para enviar los datos de transacción, junto con la cookie de Adobe Advertising del usuario, a un servidor de seguimiento, desde el cual la transacción se acredita al clic o impresión correspondientes del anuncio (según la configuración de atribución de conversión del anunciante).

Puede [generar etiquetas de seguimiento de conversión](/help/search-social-commerce/tools/conversion-tag-generate.md) en Search, Social y Commerce o mediante etiquetas en Adobe Experience Platform (anteriormente conocido como Adobe Experience Platform Launch).

>[!NOTE]
>
>Si el usuario no tiene una cookie válida, Adobe Advertising no informa de la conversión.

Para cada conjunto de métricas de conversión que desee rastrear, debe crear e implementar una etiqueta de conversión independiente. Puede generar cualquiera de los siguientes tipos de etiquetas de conversión.

* (Recomendado) Las etiquetas de JavaScript (versión 3 o 2), que no son visibles en las páginas web.

* Las etiquetas de imagen de HTML muestran imágenes transparentes de 1 píxel x 1 píxel (píxeles), que son invisibles para los usuarios finales, en las páginas web. Utilice etiquetas de imagen únicamente cuando la empresa tenga una política de no utilizar etiquetas de JavaScript.
...
## Funciones de las etiquetas de seguimiento de conversión de Adobe Advertising

El píxel de seguimiento de conversión permite a Adobe Advertising hacer lo siguiente:
...
* Proporcionar visibilidad sobre las ayudas de clic (palabras clave de búsqueda o ubicaciones que hayan contribuido a un funnel de conversión) y las ayudas para canales (eventos de usuario que han contribuido a un funnel de conversión, posiblemente en varios canales de marketing).
