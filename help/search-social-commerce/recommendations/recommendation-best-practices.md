...
description: Conozca las prácticas recomendadas para usar las  [!DNL Google Ads] recomendaciones con sus portafolios de Search, Social y Commerce.
...
|--- |--- |--- |--- |
| [!UICONTROL Ads] y extensiones (ahora denominados &quot;anuncios y recursos&quot; en [!DNL Google Ads]) | Recommendations para añadir/editar anuncios y recursos | Se puede aplicar automáticamente, pero los anunciantes deben revisar las recomendaciones manualmente. | Es necesario revisar las recomendaciones para garantizar que los anuncios de búsqueda interactivos estén alineados con los requisitos del anunciante. |
