...
Los siguientes errores pueden estar incluidos en la [!UICONTROL EF Error] columna en archivos de errores EF.
...
Los siguientes errores se producen únicamente en los archivos de errores EF. La mayoría de los errores de publicación provienen de la red de anuncios y se incluyen en un archivo de errores de SE.
