---
title: Actualizar el código de seguimiento de ID de AMO (s\_kwcid) para un [!DNL Google Ads] account
...
# Actualizar el código de seguimiento s_kwcid para un [!DNL Google Ads] account
