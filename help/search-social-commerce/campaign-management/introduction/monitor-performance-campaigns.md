...
El equipo de cuenta de Adobe, el equipo de la agencia o el anunciante (según los términos de service level agreement) deben monitorizar el rendimiento de cada campaña y portafolio (cuando corresponda) y cambiar los componentes y la configuración relevantes según sea necesario para cumplir los objetivos del anunciante.
