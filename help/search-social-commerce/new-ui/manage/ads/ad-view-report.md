---
title: (Nueva IU) Administrar informes de vista de datos desde la vista [!UICONTROL Ads]
description: Obtenga información sobre cómo generar, descargar y eliminar informes que contengan las filas de datos de uno o varios anuncios en la vista [!UICONTROL Ads].
...
# (Nueva IU) Administrar informes de vista de datos desde la vista [!UICONTROL Ads]

*característica de Beta*

Puede generar un informe que incluya las filas de datos de uno o más anuncios de la vista [!UICONTROL Ads] y, a continuación, descargar el informe como archivo de hoja de cálculo de Microsoft Excel (en formato XLXS). El informe incluye todas las columnas visibles en la vista.
