---
title: (Nueva IU) Cambiar el estado de un anuncio
description: Aprenda a cambiar el estado de un anuncio sin abrir la configuración del anuncio.
...
# (Nueva IU) Cambiar el estado de un anuncio
...
>[!MORELIKETHIS]
>
>* [(nueva interfaz de usuario) Acerca de la vista [!UICONTROL Ads]](ad-view-about.md)
