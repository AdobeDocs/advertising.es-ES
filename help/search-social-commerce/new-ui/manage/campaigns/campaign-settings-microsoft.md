...
* *[!UICONTROL Manual CPC]*: (Campañas de compra para marcas y [!DNL Microsoft Store Ads] campañas) Utiliza el modelo de coste por clic (CPC). Para algunos tipos de anuncio, puede permitir que la red de anuncios cambie las ofertas de la campaña:
...
**[!UICONTROL Local Inventory Ads]:** (solo campañas de la red de compras) Permite que la red de anuncios añada automáticamente la información del inventario local a los anuncios de compras.

**Sugerencia:** Si usa esta configuración, no excluya los anuncios locales en la configuración [!UICONTROL Inventory Filter].

**Nota:** Los anuncios de inventario local requieren dos fuentes adicionales en la cuenta del centro de comerciantes, una con los datos del producto local y otra con el inventario del producto local. Consulte la documentación de [!DNL Microsoft Advertising] para obtener más información sobre [anuncios de compras locales](https://help.ads.microsoft.com/#apex/ads/en/60055).
...
**[!UICONTROL Call to Action]:** El call to action que se va a incluir en el anuncio. De manera predeterminada, *[!UICONTROL Act Now]* está seleccionado.
