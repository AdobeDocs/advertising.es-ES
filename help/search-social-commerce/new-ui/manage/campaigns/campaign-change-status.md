---
title: (Nueva IU) Cambiar el estado de una campaña
description: Obtenga información sobre cómo cambiar el estado de una campaña sin abrir la configuración de la campaña.
...
# (Nueva IU) Cambiar el estado de una campaña
