...
>* Para cambiar rápidamente el nombre de un portafolio sin abrir la configuración completa del portafolio, consulte &quot;[Cambiar el nombre de un portafolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)&quot;.

1. En el menú principal, haga clic en **[!UICONTROL Manage]>[!UICONTROL Portfolios]**.

1. Realice una de las acciones siguientes:

   * Mantenga el cursor sobre la fila del portafolio y haga clic en ![Editar Portfolio](/help/search-social-commerce/assets/settings-new.png "Editar Portfolio").

   * Seleccione la casilla de verificación situada junto al portafolio. En la barra de herramientas de acciones masivas, haga clic en ![Editar](/help/search-social-commerce/assets/edit.png "Editar").
