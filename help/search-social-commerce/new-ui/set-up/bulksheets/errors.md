---
title: (Nueva IU) Errores de hoja de edición masiva
...
# (Nueva IU) Errores de hoja de edición masiva
...
* **Errores EF:** Cuando la operación de hoja de edición masiva no puede cargar o procesar un archivo o filas individuales del archivo, crea un archivo de error denominado `<uploaded file name>_ef_errors.<extension used for the bulksheet>`. Si el problema está en filas individuales, se incluyen esas filas, con una explicación de cada error para que pueda corregirlo. Los errores se incluyen en la columna &quot;[!UICONTROL EF Error Message]&quot;.
