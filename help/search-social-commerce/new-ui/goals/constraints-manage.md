...
### Dónde ver información acerca de las restricciones en la interfaz de usuario <!-- wording? -->
...
Puede crear, editar y cambiar el estado de las restricciones desde la vista [!UICONTROL Constraints].

>[!NOTE]
>
>Puede asignar y desasignar restricciones a las unidades de oferta desde la vista de administración de entidades correspondiente (por ejemplo, desde la vista [!UICONTROL Campaigns] para restricciones de nivel de campaña).
