...
Para generar informes en el directorio FTP designado, cree una [plantilla de informe](report-templates-manage.md) con las siguientes convenciones de nomenclatura y programación.
