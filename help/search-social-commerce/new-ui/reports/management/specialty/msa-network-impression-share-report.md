---
title: El [!UICONTROL MSA Network Impression Share Report]
description: Más información acerca de [!UICONTROL MSA Network Impression Share Report].
...
Este informe muestra las métricas de cuota de impresiones a nivel de campaña y las métricas de tráfico básicas (costo, clics, impresiones) por distribución de publicidad (búsqueda o audiencia) y red (como [!DNL Microsoft] sitios y tráfico o audiencia seleccionados) para las cuentas especificadas de [!DNL Microsoft Advertising].
