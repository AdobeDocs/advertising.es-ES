...
#### Informes de entidades de red de anuncios y Portfolio

* [El [!UICONTROL Portfolio Report]](portfolio-report.md)

* [El [!UICONTROL Search Engine Report]](search-engine-report.md)

* [El [!UICONTROL Search Engine Account Report]](search-engine-account-report.md)

* [El [!UICONTROL Campaign Report]](campaign-report.md)

* [El [!UICONTROL Campaign Hourly Report]](campaign-hourly-report.md)

* [El [!UICONTROL Ad Group Report]](ad-group-report.md)

* [El [!UICONTROL Ad Variation Report]](ad-variation-report.md)
...
* [El [!UICONTROL Label Classification Report]](label-classification-report.md)

* [El [!UICONTROL Label Value Report]](label-value-report.md)

### Informes de restricciones

* [El [!UICONTROL Constraint Report]](constraint-report.md)

* [El [!UICONTROL Network Constraint Report]](network-constraint-report.md)
...
* [El [!UICONTROL Domain Referral Report]](domain-referral-report.md)

* [El [!UICONTROL Geo Distribution Report]](geo-distribution-report.md)

* [El [!UICONTROL Transaction Report]](transaction-report.md)
...
>* [Columnas de informes para informes básicos y avanzados](basic-advanced-report-columns.md)
