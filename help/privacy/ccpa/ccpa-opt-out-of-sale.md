...
Para obtener información acerca de cómo [!DNL Advertising Search]; Advertising Creative; y [!DNL Advertising DCO] para respaldar los derechos de acceso y eliminación de información personal de los consumidores, consulte [Adobe Compatibilidad de publicidad con la Ley de Privacidad del Consumidor de California: Compatibilidad de acceso y eliminación de datos del consumidor](/help/privacy/ccpa/ccpa-access-delete.md).
