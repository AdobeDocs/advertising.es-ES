---
title: Política de requisitos de anuncios publicitarios de Adobe
...
# Política de requisitos de anuncios publicitarios de Adobe

*Última actualización: 12 de julio de 2021*

*Para la publicidad de Adobe DSP y la publicidad de Adobe Búsqueda*

Esta Política de requisitos de anuncios (&quot;Política&quot;) establece los requisitos para los anuncios distribuidos a través de los Servicios a petición de Adobe para publicidad en Adobe (&quot;Servicios&quot;). Esta Política se incorpora por referencia al Contrato entre el Adobe y el Cliente (&quot;usted&quot;) mediante los Servicios a solicitud. Los términos en mayúsculas utilizados en esta Política, pero no definidos aquí, tendrán el significado establecido en ese Acuerdo.

El Adobe se reserva el derecho de determinar, a su exclusivo criterio, si un anuncio, o el sitio web a los que el anuncio redirige o vincula, infringe los requisitos de esta Política, en cuyo caso el Adobe puede rechazar dicho anuncio y/o cancelar o suspender el acceso a los Servicios sobre esa base.
...
Todos los Anuncios transmitidos, almacenados, mostrados, distribuidos o de otro modo puestos a disposición por usted a través de los Servicios a petición deben ser consistentes con las especificaciones de publicidad contenidas en las Especificaciones de Anuncios Publicitarios de Adobe, que pueden ser revisadas por Adobe de vez en cuando.
...
* **Contenido no válido**. Los anuncios no pueden contener contenido ilegal ni promover, alentar o facilitar actividades, productos o servicios ilegales. Esto incluye, pero no se limita a, contenido, productos, actividades o servicios que involucran el uso de drogas ilícitas o parafernalia de drogas (ya sea ilegal a nivel estatal o federal) o violan las leyes de valores. A los efectos de esta Política, se prohíben los anuncios relativos a contenidos, productos, actividades o servicios relacionados con la marihuana o el cáñamo o derivados de estas sustancias, como el cannabidiol (CBD), con las siguientes excepciones: (1) productos derivados del cáñamo del CBD (pero no otros productos del CBD o del THC) en los Estados Unidos; y (2) productos de cannabis en las provincias canadienses permitidas, ambos sujetos a (a) entrar previamente en el Adobe Rider aplicable, (b) el cumplimiento de los requisitos de diligencia debida en materia de Adobe, y (c) según lo permitan los medios y las leyes aplicables. &quot;Provincias canadienses permitidas&quot; significa las provincias de Alberta, Columbia Británica, Manitoba, Nuevo Brunswick, Terranova y Labrador, Nueva Escocia, Ontario, Isla del Príncipe Eduardo y Saskatchewan.

* **Violación de los derechos o contratos de otra persona**. Los anuncios no pueden violar o infringir los derechos o contratos de otros o promocionar cualquier producto o servicio que participe en esas actividades. Esto incluye la violación de los derechos de propiedad intelectual y las violaciones de la privacidad, publicidad u otros derechos personales o de propiedad, incluida la promoción de servicios de intercambio de archivos que se utilizan principalmente para infringir los derechos de autor.
...
* **Productos falsificados o falsos**. Los anuncios no pueden promocionar ni mostrar productos falsificados o falsificados, incluidos documentos falsos, como pasaportes o documentos oficiales.

* **Contenido sexualmente sugestivo**. Los anuncios no pueden contener contenido que contenga o promueva contenido sexualmente sugestivo, incluyendo desnudez, pornografía, servicios para adultos o entretenimiento, o representaciones o lenguaje sugestivo o explícito.
...
* **Profanidad y lenguaje vulgar u obsceno.** Los anuncios no pueden contener blasfemias o lenguaje vulgar u obsceno. Los anuncios también pueden no incluir lenguaje que pretenda lograr el mismo efecto pero que oscurezca la blasfemia.

* **Anuncios llenos de odio**. Los anuncios no pueden promover ni relacionarse con el discurso de odio o la intolerancia religiosa y no pueden menospreciar a un individuo o grupo en base a su raza u origen étnico, religión, discapacidad, condición médica o genética, edad, nacionalidad u origen nacional, estado de veterano de guerra, estado de refugiado, estado de inmigración, orientación sexual, género, identidad de género u otra característica que esté asociada con la discriminación o marginación sistémica.

* **Eventos confidenciales**. Los anuncios no pueden capitalizar o no tener una sensibilidad razonable hacia cualquier desastre natural, conflicto, muerte, epidemia, pandemia, evento trágico o temor público.
...
* **Direccionamiento prohibido**. Los anuncios no pueden estar dirigidos a una audiencia o dirigidos a ella en función de cualquiera de los siguientes factores, ya sean conocidos o deducidos:
